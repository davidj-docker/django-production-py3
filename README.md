# django-production
Dockerfile that creates a Django (Python 3.4.x) production environment on Ubuntu Trusty, running on uWSGI and nginx, designed for deployment on an Apache Mesos/Marathon cluster.
